                          ...
                          <div class="card-body">
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="municipality" name="province2" >
                                </div>
                                <div class="col-md-6">
                        ...
                        <div class="card bg-light">
                          <div class="card-body">
                            ...
                            <div class="col-md-12">
                                ...
                                <ul name="specification2" id="specs_group_edit"></ul>
                            </div>
                              <div class="col-md-12">
                                  <label for="inputCity" class="form-label">Volume/Tonnage</label>
                                  <input type="text" class="form-control" id="tonnage" name="tonnage2" required>
                              </div>
                              <div class="col-md-12">
                                  <label for="inputCity" class="form-label">No. of Vehicle</label>
                                  <input type="text" class="form-control" id="num_vehicle" name="num_vehicle2" readonly="" required>
                              </div>
                          </div>
                        </div>
                      </div>
